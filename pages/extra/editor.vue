...
<script>
	export default {
		...
		onLoad(e) {
			...
			var urlon = encodeURIComponent(getApp().globalData.zddomain + 'forum.php?mod=post&action=edit&fid=' + e.fid + '&tid=' + e.tid + '&pid=' + e.pid + '&mobile=2');
